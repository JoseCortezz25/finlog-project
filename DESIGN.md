...
- Use pill shape for primary CTAs only. Badges/pills must be rare and functional, not decorative section labels.
...
- Don't exaggerate with badges, pills, uppercase kickers, or status chips. Avoid decorative labels like “Vista financiera”, “Bloque operativo”, “Workspace local”, or “Panorama financiero”.
- Don't use heavy drop shadows to create hierarchy. Editorial depth must come from spacing, hairlines, typography, and very subtle elevation.
